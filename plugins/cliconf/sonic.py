...
---
name: sonic
short_description: Use sonic cliconf to run command on Enterprise/Community SONiC platform
description:
  - This sonic plugin provides low level abstraction apis for
    sending and receiving CLI commands from Enterprise/Community SONiC network devices.
"""
