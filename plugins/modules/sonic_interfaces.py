...
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.configs.interfaces import InterfaceConfig
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.argspecification.interfaces import InterfacesArgs
...
def main():
    ...
    commands, diff = InterfaceConfig().get_config_commands(module, get_current_config=True)
