...
def main():
    ...
    """
    module = AnsibleModule(argument_spec=SVIArgs.argument_spec, supports_check_mode=True)
    ...
    commands, diff = SVIConfig().get_config_commands(module, get_current_config=True)
