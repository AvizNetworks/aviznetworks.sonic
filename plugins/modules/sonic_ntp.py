...
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.configs.ntp import NTPConfig
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.argspecification.ntp import NTPArgs
...
def main():
    ...
    """
    module = AnsibleModule(argument_spec=NTPArgs.argument_spec, supports_check_mode=True)
    ...
    commands, diff = NTPConfig().get_config_commands(module, get_current_config=True)
