...
from ansible_collections.aviznetworks.sonic_fmcli.plugins.module_utils.network.sonic.configs.loopback import LoopbackConfig
from ansible_collections.aviznetworks.sonic_fmcli.plugins.module_utils.network.sonic.argspecification.loopback import LoopbackArgs
...
def main():
    ...
    """
    module = AnsibleModule(argument_spec=LoopbackArgs.argument_spec, supports_check_mode=True)
    ...
    commands, diff = LoopbackConfig().get_config_commands(module, get_current_config=True)
