...
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.configs.snmp import SNMPConfig
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.argspecification.snmp import SNMPArgs
...
def main():
    ...
    """
    module = AnsibleModule(argument_spec=SNMPArgs.argument_spec, supports_check_mode=True)
    ...
    commands, diff = SNMPConfig().get_config_commands(module, get_current_config=True)
