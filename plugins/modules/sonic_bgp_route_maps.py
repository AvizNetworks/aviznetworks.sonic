...
from ansible_collections.aviznetworks.ansible.plugins.module_utils.network.sonic.configs.route_maps import BGPProtocolConfig
from ansible_collections.aviznetworks.ansible.plugins.module_utils.network.sonic.argspecification.route_maps import BGPProtocolArgs
...
def main():
    ...
    commands = list()
    commands, diff = BGPProtocolConfig().get_config_commands(module, get_current_config=True)
