...
from ansible_collections.aviznetworks.sonic_fmcli.plugins.module_utils.network.sonic.configs.bgp_protocol import BGPProtocolConfig
from ansible_collections.aviznetworks.sonic_fmcli.plugins.module_utils.network.sonic.argspecification.bgp_protocol import BGPProtocolArgs
...
def main():
    ...
    """
    module = AnsibleModule(argument_spec=BGPProtocolArgs.argument_spec, supports_check_mode=True)
    ...
    commands = list()
    commands.extend(BGPProtocolConfig().get_config_commands(module, get_current_config=True))
