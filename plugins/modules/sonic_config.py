...
description:
  - Manages configuration sections of Enterprise SONiC Distribution
    . SONiC configurations use a simple block indent
...
EXAMPLES = """
- aviznetworks.sonic.sonic_config:
...
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.sonic import get_config, get_sublevel_config
from ansible_collections.aviznetworks.sonic.plugins.module_utils.network.sonic.sonic import edit_config, run_commands
